	soc_system u0 (
		...
		.audio_interface_gpio_din_GPIO_DIN       (<connected-to-audio_interface_gpio_din_GPIO_DIN>),       //    audio_interface_gpio_din.GPIO_DIN
		.audio_interface_gpio_din2_GPIO_DIN2     (<connected-to-audio_interface_gpio_din2_GPIO_DIN2>),     //   audio_interface_gpio_din2.GPIO_DIN2
		.audio_interface_aud_bclk_AUD_BCLK       (<connected-to-audio_interface_aud_bclk_AUD_BCLK>),       //    audio_interface_aud_bclk.AUD_BCLK
		.audio_interface_aud_adclrck_AUD_ADCLRCK (<connected-to-audio_interface_aud_adclrck_AUD_ADCLRCK>), // audio_interface_aud_adclrck.AUD_ADCLRCK
		.audio_interface_codec_left_codec_left   (<connected-to-audio_interface_codec_left_codec_left>),   //  audio_interface_codec_left.codec_left
		.audio_interface_codec_right_codec_right (<connected-to-audio_interface_codec_right_codec_right>)  // audio_interface_codec_right.codec_right
	);
