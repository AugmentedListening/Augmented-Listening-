...
module soc_system_mm_interconnect_0 (
		...
		output wire [3:0]  Audio_Interface_AUDIO_SLAVE_address,                              //                                Audio_Interface_AUDIO_SLAVE.address
		output wire        Audio_Interface_AUDIO_SLAVE_write,                                //                                                           .write
		output wire        Audio_Interface_AUDIO_SLAVE_read,                                 //                                                           .read
		input  wire [31:0] Audio_Interface_AUDIO_SLAVE_readdata,                             //                                                           .readdata
		output wire [31:0] Audio_Interface_AUDIO_SLAVE_writedata,                            //                                                           .writedata
		output wire        Audio_Interface_AUDIO_SLAVE_chipselect,                           //                                                           .chipselect
	...
	wire   [31:0] audio_interface_audio_slave_agent_m0_readdata;                                      // Audio_Interface_AUDIO_SLAVE_translator:uav_readdata -> Audio_Interface_AUDIO_SLAVE_agent:m0_readdata
	wire          audio_interface_audio_slave_agent_m0_waitrequest;                                   // Audio_Interface_AUDIO_SLAVE_translator:uav_waitrequest -> Audio_Interface_AUDIO_SLAVE_agent:m0_waitrequest
	wire          audio_interface_audio_slave_agent_m0_debugaccess;                                   // Audio_Interface_AUDIO_SLAVE_agent:m0_debugaccess -> Audio_Interface_AUDIO_SLAVE_translator:uav_debugaccess
	wire   [31:0] audio_interface_audio_slave_agent_m0_address;                                       // Audio_Interface_AUDIO_SLAVE_agent:m0_address -> Audio_Interface_AUDIO_SLAVE_translator:uav_address
	wire    [3:0] audio_interface_audio_slave_agent_m0_byteenable;                                    // Audio_Interface_AUDIO_SLAVE_agent:m0_byteenable -> Audio_Interface_AUDIO_SLAVE_translator:uav_byteenable
	wire          audio_interface_audio_slave_agent_m0_read;                                          // Audio_Interface_AUDIO_SLAVE_agent:m0_read -> Audio_Interface_AUDIO_SLAVE_translator:uav_read
	wire          audio_interface_audio_slave_agent_m0_readdatavalid;                                 // Audio_Interface_AUDIO_SLAVE_translator:uav_readdatavalid -> Audio_Interface_AUDIO_SLAVE_agent:m0_readdatavalid
	wire          audio_interface_audio_slave_agent_m0_lock;                                          // Audio_Interface_AUDIO_SLAVE_agent:m0_lock -> Audio_Interface_AUDIO_SLAVE_translator:uav_lock
	wire   [31:0] audio_interface_audio_slave_agent_m0_writedata;                                     // Audio_Interface_AUDIO_SLAVE_agent:m0_writedata -> Audio_Interface_AUDIO_SLAVE_translator:uav_writedata
	wire          audio_interface_audio_slave_agent_m0_write;                                         // Audio_Interface_AUDIO_SLAVE_agent:m0_write -> Audio_Interface_AUDIO_SLAVE_translator:uav_write
	wire    [2:0] audio_interface_audio_slave_agent_m0_burstcount;                                    // Audio_Interface_AUDIO_SLAVE_agent:m0_burstcount -> Audio_Interface_AUDIO_SLAVE_translator:uav_burstcount
	wire          audio_interface_audio_slave_agent_rf_source_valid;                                  // Audio_Interface_AUDIO_SLAVE_agent:rf_source_valid -> Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:in_valid
	wire  [129:0] audio_interface_audio_slave_agent_rf_source_data;                                   // Audio_Interface_AUDIO_SLAVE_agent:rf_source_data -> Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:in_data
	wire          audio_interface_audio_slave_agent_rf_source_ready;                                  // Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:in_ready -> Audio_Interface_AUDIO_SLAVE_agent:rf_source_ready
	wire          audio_interface_audio_slave_agent_rf_source_startofpacket;                          // Audio_Interface_AUDIO_SLAVE_agent:rf_source_startofpacket -> Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:in_startofpacket
	wire          audio_interface_audio_slave_agent_rf_source_endofpacket;                            // Audio_Interface_AUDIO_SLAVE_agent:rf_source_endofpacket -> Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:in_endofpacket
	wire          audio_interface_audio_slave_agent_rsp_fifo_out_valid;                               // Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:out_valid -> Audio_Interface_AUDIO_SLAVE_agent:rf_sink_valid
	wire  [129:0] audio_interface_audio_slave_agent_rsp_fifo_out_data;                                // Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:out_data -> Audio_Interface_AUDIO_SLAVE_agent:rf_sink_data
	wire          audio_interface_audio_slave_agent_rsp_fifo_out_ready;                               // Audio_Interface_AUDIO_SLAVE_agent:rf_sink_ready -> Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:out_ready
	wire          audio_interface_audio_slave_agent_rsp_fifo_out_startofpacket;                       // Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:out_startofpacket -> Audio_Interface_AUDIO_SLAVE_agent:rf_sink_startofpacket
	wire          audio_interface_audio_slave_agent_rsp_fifo_out_endofpacket;                         // Audio_Interface_AUDIO_SLAVE_agent_rsp_fifo:out_endofpacket -> Audio_Interface_AUDIO_SLAVE_agent:rf_sink_endofpacket
	wire          audio_interface_audio_slave_agent_rdata_fifo_src_valid;                             // Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_src_valid -> Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:in_valid
	wire   [33:0] audio_interface_audio_slave_agent_rdata_fifo_src_data;                              // Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_src_data -> Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:in_data
	wire          audio_interface_audio_slave_agent_rdata_fifo_src_ready;                             // Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:in_ready -> Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_src_ready
	...
	wire  [129:0] buttons_s1_agent_rf_source_data;                                                    // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] buttons_s1_agent_rsp_fifo_out_data;                                                 // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire          audio_interface_audio_slave_agent_rp_valid;                                         // Audio_Interface_AUDIO_SLAVE_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] audio_interface_audio_slave_agent_rp_data;                                          // Audio_Interface_AUDIO_SLAVE_agent:rp_data -> router_009:sink_data
	wire          audio_interface_audio_slave_agent_rp_ready;                                         // router_009:sink_ready -> Audio_Interface_AUDIO_SLAVE_agent:rp_ready
	wire          audio_interface_audio_slave_agent_rp_startofpacket;                                 // Audio_Interface_AUDIO_SLAVE_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          audio_interface_audio_slave_agent_rp_endofpacket;                                   // Audio_Interface_AUDIO_SLAVE_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [128:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_011:sink_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> Audio_Interface_AUDIO_SLAVE_burst_adapter:sink0_endofpacket
	wire          audio_interface_audio_slave_burst_adapter_source0_valid;                            // Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_valid -> Audio_Interface_AUDIO_SLAVE_agent:cp_valid
	wire  [128:0] audio_interface_audio_slave_burst_adapter_source0_data;                             // Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_data -> Audio_Interface_AUDIO_SLAVE_agent:cp_data
	wire          audio_interface_audio_slave_burst_adapter_source0_ready;                            // Audio_Interface_AUDIO_SLAVE_agent:cp_ready -> Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_ready
	wire    [6:0] audio_interface_audio_slave_burst_adapter_source0_channel;                          // Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_channel -> Audio_Interface_AUDIO_SLAVE_agent:cp_channel
	wire          audio_interface_audio_slave_burst_adapter_source0_startofpacket;                    // Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_startofpacket -> Audio_Interface_AUDIO_SLAVE_agent:cp_startofpacket
	wire          audio_interface_audio_slave_burst_adapter_source0_endofpacket;                      // Audio_Interface_AUDIO_SLAVE_burst_adapter:source0_endofpacket -> Audio_Interface_AUDIO_SLAVE_agent:cp_endofpacket
	...
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> buttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // buttons_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> buttons_s1_burst_adapter:sink0_channel
	...
	wire  [128:0] buttons_s1_burst_adapter_source0_data;                                              // buttons_s1_burst_adapter:source0_data -> buttons_s1_agent:cp_data
	...
	wire          audio_interface_audio_slave_agent_rdata_fifo_out_valid;                             // Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] audio_interface_audio_slave_agent_rdata_fifo_out_data;                              // Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          audio_interface_audio_slave_agent_rdata_fifo_out_ready;                             // avalon_st_adapter_004:in_0_ready -> Audio_Interface_AUDIO_SLAVE_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> Audio_Interface_AUDIO_SLAVE_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) audio_interface_audio_slave_translator (
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (audio_interface_audio_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (audio_interface_audio_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (audio_interface_audio_slave_agent_m0_read),           //                         .read
		.uav_write              (audio_interface_audio_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (audio_interface_audio_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (audio_interface_audio_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (audio_interface_audio_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (audio_interface_audio_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (audio_interface_audio_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (audio_interface_audio_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (audio_interface_audio_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (Audio_Interface_AUDIO_SLAVE_address),                 //      avalon_anti_slave_0.address
		.av_write               (Audio_Interface_AUDIO_SLAVE_write),                   //                         .write
		.av_read                (Audio_Interface_AUDIO_SLAVE_read),                    //                         .read
		.av_readdata            (Audio_Interface_AUDIO_SLAVE_readdata),                //                         .readdata
		.av_writedata           (Audio_Interface_AUDIO_SLAVE_writedata),               //                         .writedata
		.av_chipselect          (Audio_Interface_AUDIO_SLAVE_chipselect),              //                         .chipselect
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_interface_audio_slave_agent (
		.clk                     (clk_0_clk_clk),                                                   //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (audio_interface_audio_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (audio_interface_audio_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (audio_interface_audio_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (audio_interface_audio_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (audio_interface_audio_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (audio_interface_audio_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (audio_interface_audio_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (audio_interface_audio_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (audio_interface_audio_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (audio_interface_audio_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (audio_interface_audio_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (audio_interface_audio_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (audio_interface_audio_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (audio_interface_audio_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (audio_interface_audio_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (audio_interface_audio_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (audio_interface_audio_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (audio_interface_audio_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (audio_interface_audio_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (audio_interface_audio_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (audio_interface_audio_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (audio_interface_audio_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (audio_interface_audio_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (audio_interface_audio_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (audio_interface_audio_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (audio_interface_audio_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (audio_interface_audio_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (audio_interface_audio_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (audio_interface_audio_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (audio_interface_audio_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (audio_interface_audio_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (audio_interface_audio_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                               //                .error
		.rdata_fifo_src_ready    (audio_interface_audio_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_interface_audio_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (audio_interface_audio_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_interface_audio_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (audio_interface_audio_slave_agent_rf_source_data),             //        in.data
		.in_valid          (audio_interface_audio_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_interface_audio_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_interface_audio_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_interface_audio_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_interface_audio_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_interface_audio_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_interface_audio_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_interface_audio_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_interface_audio_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_interface_audio_slave_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                          //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (audio_interface_audio_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (audio_interface_audio_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (audio_interface_audio_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (audio_interface_audio_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (audio_interface_audio_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (audio_interface_audio_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	soc_system_mm_interconnect_0_router_009 router_009 (
		.sink_ready         (audio_interface_audio_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (audio_interface_audio_slave_agent_rp_valid),          //          .valid
		.sink_data          (audio_interface_audio_slave_agent_rp_data),           //          .data
		.sink_startofpacket (audio_interface_audio_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (audio_interface_audio_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) audio_interface_audio_slave_burst_adapter (
		.clk                   (clk_0_clk_clk),                                                   //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),             // cr0_reset.reset
		...
		.source0_valid         (audio_interface_audio_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (audio_interface_audio_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (audio_interface_audio_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (audio_interface_audio_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (audio_interface_audio_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (audio_interface_audio_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                          // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (audio_interface_audio_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (audio_interface_audio_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (audio_interface_audio_slave_agent_rdata_fifo_out_ready), //         .ready
